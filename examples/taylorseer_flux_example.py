...
from xfuser.model_executor.taylorseer.forwards import taylorseer_flux_single_block_forward, taylorseer_flux_double_block_forward, taylorseer_xfuser_flux_forward

def main():
    parser = FlexibleArgumentParser(description="xFuser TaylorSeer Arguments")
    ...
    # Apply TaylorSeer modifications
    if not torch.distributed.is_initialized() or get_tensor_model_parallel_world_size() == 1:
    ...
    # Set the number of steps for TaylorSeer
    pipe.transformer.__class__.num_steps = input_config.num_inference_steps
    
    # Apply TaylorSeer forward functions
    ...
    if input_config.output_type == "pil":
        ...
        if pipe.is_dp_last_group():
            for i, image in enumerate(output.images):
                ...
                image_name = f"taylorseer_flux_result_{parallel_info}_{image_rank}_tc_{engine_args.use_torch_compile}.png"
